...
$GLOBALS['TYPO3_CONF_VARS']['FE']['concatenateHandler'] = t3lib_extMgm::extPath($_EXTKEY).'classes/hooks/class.tx_js_css_optimizer_hooks_concatenateHandler.php:&tx_js_css_optimizer_hooks_concatenateHandler->process';
